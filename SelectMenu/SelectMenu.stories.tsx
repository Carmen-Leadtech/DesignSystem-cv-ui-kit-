...
const AllVariantsAndStatesTemplate: StoryFn<SelectMenuProps> = () => {
  const optionRef1 = useRef<(HTMLLIElement | null)[]>([]);
  const parentRef1 = useRef<HTMLDivElement | null>(null);
  const optionRef2 = useRef<(HTMLLIElement | null)[]>([]);
  const parentRef2 = useRef<HTMLDivElement | null>(null);
  const optionRef3 = useRef<(HTMLLIElement | null)[]>([]);
  const parentRef3 = useRef<HTMLDivElement | null>(null);
  const optionRef4 = useRef<(HTMLLIElement | null)[]>([]);
  const parentRef4 = useRef<HTMLDivElement | null>(null);
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      <div style={{ ...rowStyle, paddingBottom: '0', alignItems: 'center' }}>
        <span />
        <span style={{ fontWeight: 600 }}>Default</span>
      </div>

      <div style={{ ...rowStyle, backgroundColor: '#f8fafc' }}>
        <span style={{ fontWeight: 500, color: '#64748b' }}>Normal</span>
        <div ref={parentRef1} style={{ position: 'relative', width: '280px', height: '120px' }}>
          <SelectMenu
      ...
      <div style={{ ...rowStyle, backgroundColor: 'transparent' }}>
        <span style={{ fontWeight: 500, color: '#64748b' }}>Hover</span>
        <div ref={parentRef2} style={{ position: 'relative', width: '280px', height: '120px' }}>
          <SelectMenu
            options={[{ label: 'Option A', value: 'a' }]}
            onChange={() => {}}
            onClose={() => {}}
      ...
      <div style={{ ...rowStyle, backgroundColor: '#f8fafc' }}>
        <span style={{ fontWeight: 500, color: '#64748b' }}>Selected</span>
        <div ref={parentRef3} style={{ position: 'relative', width: '280px', height: '120px' }}>
          <SelectMenu
            options={[{ label: 'Option A', value: 'a' }]}
            onChange={() => {}}
            onClose={() => {}}
      ...
      <div style={{ ...rowStyle, backgroundColor: 'transparent' }}>
        <span style={{ fontWeight: 500, color: '#64748b' }}>Selected Hover</span>
        <div ref={parentRef4} style={{ position: 'relative', width: '280px', height: '120px' }}>
          <SelectMenu
            options={[{ label: 'Option A', value: 'a' }]}
            onChange={() => {}}
            onClose={() => {}}
            value="a"
            name="selected-hover-menu"
            optionRef={optionRef4}
...
AllVariantsAndStates.parameters = {
  pseudo: {
    hover: ['#hover-menu-listbox li', '#selected-hover-menu-listbox li'],
  },
  docs: {
    description: {
      story: 'Comparison of all variants and their states (normal, hover, selected).',
    },
  },
};
