...
const AllVariantsAndStatesTemplate: StoryFn<ChipProps> = () => (
  <div
    style={{
      display: 'grid',
  ...
  >
    ...
    <span style={{ fontWeight: 600 }}>With Icons</span>

    <span style={{ justifySelf: 'start' }}>Normal</span>
    <Chip>Chip</Chip>
    <Chip isSelected>Chip</Chip>
    <Chip draggableProps={{}} onClickClose={() => {}}>
      Chip
    </Chip>

    <span style={{ justifySelf: 'start' }}>Hover</span>
    <Chip id="hover-default">Chip</Chip>
    <Chip id="hover-selected" isSelected>
      Chip
    </Chip>
    <Chip id="hover-icons" draggableProps={{}} onClickClose={() => {}}>
      Chip
    </Chip>

    <span style={{ justifySelf: 'start' }}>Focus</span>
    <Chip id="focus-default">Chip</Chip>
    <Chip id="focus-selected" isSelected>
      Chip
    </Chip>
    <Chip id="focus-icons" draggableProps={{}} onClickClose={() => {}}>
      Chip
    </Chip>
  </div>
);
...
AllVariantsAndStates.parameters = {
  pseudo: {
    hover: ['#hover-default', '#hover-selected', '#hover-icons'],
    focusVisible: ['#focus-default', '#focus-selected', '#focus-icons'],
  },
  docs: {
    description: {
