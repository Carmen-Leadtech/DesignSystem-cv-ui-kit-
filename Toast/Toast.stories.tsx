...
const AllVariantsAndStatesTemplate: StoryFn<ToastProps> = () => (
  <div
    style={{
      display: 'grid',
...
AllVariantsAndStates.parameters = {
  ...
  docs: {
    description: {
      story: 'Comparison of all variants and their states (hover, focus on close button).',
    },
  },
};
