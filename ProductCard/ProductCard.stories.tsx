...
const AllVariantsAndStatesTemplate: StoryFn<ProductCardProps> = () => (
  <div
    style={{
      display: 'grid',
  ...
  >
    ...
    <span style={{ fontWeight: 600 }}>XS</span>
    <span style={{ fontWeight: 600 }}>S</span>
    <span style={{ fontWeight: 600 }}>M</span>

    <span style={{ justifySelf: 'start' }}>Normal</span>
    <ProductCard size="XS" title="Title" subtitle="Subtitle" icon={<Icon name="studies" />} />
    <ProductCard size="S" title="Title" subtitle="Subtitle" icon={<Icon name="studies" />} />
    <ProductCard
      size="M"
      image={<img src="https://placehold.co/279x144" alt="Product" />}
      title="Medium Card"
...
AllVariantsAndStates.parameters = {
  pseudo: {
    hover: ['#hover-xs', '#hover-s', '#hover-m'],
    active: ['#active-xs', '#active-s', '#active-m'],
    focusVisible: ['#focus-xs', '#focus-s', '#focus-m'],
  },
  docs: {
    description: {
