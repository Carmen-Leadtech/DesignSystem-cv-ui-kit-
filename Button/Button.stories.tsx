...
const AllVariantsAndStatesTemplate: StoryFn<ButtonProps> = () => (
  <div
    style={{
      display: 'grid',
  ...
  >
    ...
    <span style={{ fontWeight: 600 }}>Gradient</span>
    ...
    <Button variant="tool">Button</Button>

    <span style={{ justifySelf: 'start' }}>Hover</span>
    <Button variant="primary" id="hover-primary">
      Button
    </Button>
    <Button variant="secondary" id="hover-secondary">
      Button
    </Button>
    <Button variant="gradient" id="hover-gradient">
      Button
    </Button>
    <Button variant="tool" id="hover-tool">
      Button
    </Button>

    <span style={{ justifySelf: 'start' }}>Active</span>
    <Button variant="primary" id="active-primary">
      Button
    </Button>
    <Button variant="secondary" id="active-secondary">
      Button
    </Button>
    <Button variant="gradient" id="active-gradient">
      Button
    </Button>
    <Button variant="tool" id="active-tool">
      Button
    </Button>

    <span style={{ justifySelf: 'start' }}>Focus</span>
    <Button variant="primary" id="focus-primary">
      Button
    </Button>
    <Button variant="secondary" id="focus-secondary">
      Button
    </Button>
    <Button variant="gradient" id="focus-gradient">
      Button
    </Button>
    <Button variant="tool" id="focus-tool">
      Button
    </Button>
...
AllVariantsAndStates.parameters = {
  pseudo: {
    hover: ['#hover-primary', '#hover-secondary', '#hover-gradient', '#hover-tool'],
    active: ['#active-primary', '#active-secondary', '#active-gradient', '#active-tool'],
    focus: ['#focus-primary', '#focus-secondary', '#focus-gradient', '#focus-tool'],
  },
  docs: {
    description: {
