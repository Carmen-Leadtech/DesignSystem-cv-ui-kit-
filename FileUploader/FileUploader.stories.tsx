...
const AllVariantsAndStatesTemplate: StoryFn<FileUploaderProps> = () => (
  <div
    style={{
      display: 'grid',
  ...
  >
    ...
    <FileUploader labels={defaultLabels} onAttachedHandler={() => {}} />

    <span style={{ justifySelf: 'start' }}>Hover</span>
    <FileUploader id="hover-default" labels={defaultLabels} onAttachedHandler={() => {}} />
  </div>
);
...
AllVariantsAndStates.parameters = {
  ...
  docs: {
    description: {
      story: 'Comparison of all variants and their states (hover).',
    },
  },
};
