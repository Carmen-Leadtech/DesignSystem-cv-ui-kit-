...
const AllVariantsAndStatesTemplate: StoryFn<SwitchProps> = () => (
  <div
    style={{
      display: 'grid',
  ...
  >
    ...
    <Switch label="Option" />
    <Switch label="Option" defaultChecked />

    <span style={{ justifySelf: 'start' }}>Focus</span>
    <Switch id="focus-unchecked" label="Option" />
    <Switch id="focus-checked" label="Option" defaultChecked />

    <span style={{ justifySelf: 'start' }}>Disabled</span>
    <Switch label="Option" disabled />
    <Switch label="Option" defaultChecked disabled />
  </div>
);
...
AllVariantsAndStates.parameters = {
  ...
  docs: {
    description: {
      story: 'Comparison of all variants and their states (focus, disabled).',
    },
  },
};
