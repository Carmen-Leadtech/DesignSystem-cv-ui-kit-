...
const AllVariantsAndStatesTemplate: StoryFn<DialogProps> = () => (
  <div
    style={{
      display: 'grid',
  ...
  >
    ...
    <span style={{ justifySelf: 'end' }}>Normal</span>
    <Dialog className="inline-dialog" isOpen maxWidth="xs" showCloseButton>
    ...
    <span style={{ justifySelf: 'end' }}>Active</span>
    <Dialog
      className="inline-dialog"
      isOpen
      maxWidth="xs"
      showCloseButton
      buttonIconCloseProps={{ id: 'active-close' }}
    >
      <div style={{ padding: '16px' }}>
        <h2>Dialog Content</h2>
        <p>
    ...
    <span style={{ justifySelf: 'end' }}>Focus</span>
    <Dialog
      className="inline-dialog"
      isOpen
      maxWidth="xs"
      showCloseButton
      paperProps={{ id: 'focus-dialog' }}
    >
      <div style={{ padding: '16px' }}>
        <h2>Dialog Content</h2>
        <p>
...
AllVariantsAndStates.parameters = {
  pseudo: {
    active: ['#active-close'],
    focusVisible: ['#focus-dialog'],
  },
  docs: {
    description: {
      story:
        'Comparison of all variants and their states (active on close button, focus on dialog).',
    },
  },
};
