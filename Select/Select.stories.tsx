...
const AllVariantsAndStatesTemplate: StoryFn<SelectProps> = () => (
  <div
    style={{
      display: 'grid',
...
AllVariantsAndStates.parameters = {
  pseudo: {
    hover: ['#hover-default', '#hover-error'],
    focus: ['#focus-default', '#focus-error'],
    focusVisible: ['#focus-default > div:first-child', '#focus-error > div:first-child'],
    focusWithin: ['#focus-default', '#focus-error'],
  },
  docs: {
    description: {
